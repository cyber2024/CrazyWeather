 ...
 */
package com.ggg.crazyweather.sunshine.data;
...
import com.ggg.crazyweather.data.WeatherDbHelper;
import com.ggg.crazyweather.data.WeatherProvider;
...
public class TestProvider extends ApplicationTestCase<Application> {
    ...
    public TestProvider(Class<Application> applicationClass) {
